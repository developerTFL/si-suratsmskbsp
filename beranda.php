    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert beranda">
                <strong>Selamat Datang di SI Pencatatan Surat Masuk dan Surat Keluar PT. BSP Bunut Rubber Factory</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Surat Masuk dan Surat Keluar</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" name="login" value="login"
                                        class="btn btn-info1 btn-block"><span class="fa fa-unlock-alt"></span>
                                    Login Sistem
                                </button>
                            </div>
                    </form>
